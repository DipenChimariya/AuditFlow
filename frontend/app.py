...
st.title("💼 Welcome to AuditFlow Workspace")
st.write("---")

st.markdown("""
### 🚀 Centralized Auditing Ecosystem
Select an operational module from the sidebar navigation menu on the left to get started:

* **🏢 Client Directory:** Register new audit clients and review structural corporate data profiles.
* **📄 Invoice Ledger:** Log, track, filter, and export fiscal tax invoices.
* **📦 Inventory Tracking:** Reconcile inventory balances (Opening, Purchased, Sold, Remaining) on a per-client basis.
""")

st.info("Click on any module to hop between tools instantly!")
